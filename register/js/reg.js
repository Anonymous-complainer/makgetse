...
function validateForm() {
    ...
    if (email === '' || grade === '' || username === '' || password === '') {
    ...
    const sanitizedgrade = grade.replace(/[^\d]/gi, '');
    ...
    const formData_ = {
        ...
        grade: en(sanitizedgrade, currentYear),
        username: en(sanitizedUsername, currentYear),
        password: en(sanitizedPassword, currentYear),
        cy: currentYear
    };
    const data = { data: `${formData_.email}(@)${formData_.grade}(@)${formData_.username}(@)${formData_.password}(@)${formData_.cy}(@)` }
